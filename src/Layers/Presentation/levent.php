                ...
                <div class="col-md-8 col-lg-8 col-xl-6">
                    ...
                    <section>
                        <div class="page-content">
                            <h4>Evenementen toevoegen</h4>
                            <form action="eventcontroller.php?action=add" method="post">
                            		...
                            		<div class="row">
                            			...
                            			<div class="col-xs-0 col-md-6 col-lg-6 col-xl-4" style="box-shadow: none">
                            				<div class="form-group">
			                            		<label>Datum</label>
			                            		<input type="text" id="datepicker" name="date" placeholder="Datum" class="form-control" readonly="true" required="true">
			                            	</div>
			                            	<div class="form-group">
			                            		<label>Uur</label>
			                            		<input type="time" id="" name="time" placeholder="Datum" class="form-control" required="true">
			                            	</div>
			                            	<div class="form-group">
			                            	...
			                            	<div class="form-group">
			                            		...
			                            		<textarea name="comment" maxlength="250" placeholder="Bijkomende opmerkingen" class="form-control"></textarea>
			                            	</div>
			                            	<div class="form-group">
			                            		<label>Lokatie</label>
			                            		<input type="text" id="" name="location" placeholder="Lokatie" class="form-control">
			                            	</div>
			                            	<div class="form-group">
